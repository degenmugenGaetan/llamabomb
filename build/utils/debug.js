...
export function drawEntityBox(context, camera, position, direction, dimensions, color) {
    ...
    context.fillRect(Math.floor(position.x + (x * direction) - camera.position.x) + 0.5, Math.floor(position.y + y - camera.position.y) + 0.5, (width * direction), height);
    context.rect(Math.floor(position.x + (x * direction) - camera.position.x) + 0.5, Math.floor(position.y + y - camera.position.y) + 0.5, (width * direction), height);
    context.stroke();
}
export function drawBox(context, camera, dimensions, color) {
    ...
    context.strokeStyle = color + 'AA';
    context.fillStyle = color + '44';
    context.fillRect(Math.floor(x - camera.position.x) + 0.5, Math.floor(y - camera.position.y) + 0.5, width, height);
    context.rect(Math.floor(x - camera.position.x) + 0.5, Math.floor(y - camera.position.y) + 0.5, width, height);
    context.stroke();
}
