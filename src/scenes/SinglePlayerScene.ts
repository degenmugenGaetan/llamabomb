...
import { GameTime, IEntity, onSceneEndHandler } from '../engine/types.js';
...
import { EnemyType } from '../constants/enemies.js';
...
export class SinglePlayerScene extends Scene {
	level: LevelMap;
	panel: SinglePlayerPanel;
	player: Bomberman;
	camera: Camera;
	systems: System<IEntity>[];
	enemySystem: EnemySystem;
	shadowSystem: ShadowSystem;
	onEnd: onSceneEndHandler;

	music = document.querySelector<HTMLAudioElement>('audio#bgm');

	difficulty: string;

	constructor(time: GameTime, onEnd: onSceneEndHandler, difficulty: string) {
		super();
