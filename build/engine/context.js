export function createContext(width, height, parentSelector = 'body') {
...
export function drawFrame(context, image, dimensions, x, y, scale = [1, 1]) {
    ...
    context.drawImage(image, sourceX, sourceY, sourceWidth, sourceHeight, x * scale[0], y * scale[1], sourceWidth, sourceHeight);
