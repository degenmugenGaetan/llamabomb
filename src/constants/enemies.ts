...
export const enemyFrames: FrameDataMap = new Map([
...
export type EnemyAnimationList = Record<ValueOf<typeof EnemyStateType>, readonly AnimationFrame[]>;

export const orangeOneAnimations: EnemyAnimationList = {
...
export const explodeFrames: FrameDataMap = new Map([
